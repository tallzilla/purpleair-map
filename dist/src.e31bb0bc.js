...
},{"whatwg-fetch":"../node_modules/whatwg-fetch/fetch.js"}],"../node_modules/fetch-retry/index.js":[function(require,module,exports) {
'use strict';
...
var process = require('process'); //from https://www.npmjs.com/package/fetch-retry


var originalFetch = require('isomorphic-fetch');

var fetch = require('fetch-retry')(originalFetch); // Create the script tag, set the appropriate attributes


var script = document.createElement('script');
var api_key = "AIzaSyD3Zs-gMW0thfy0m90zhZGS4QH5mv6UU8c";
console.log("Secrets try:" + "AIzaSyD3Zs-gMW0thfy0m90zhZGS4QH5mv6UU8c");
...
window.initMap = function () {
  ...
  var _loop = function _loop(id) {
    var url = "https://www.purpleair.com/json?show=" + purpleDeviceIds[id];
    fetch(url, fetchSettings).then(function (response) {
      ...
      var sensor = json.results[0];
      var lat = sensor['Lat'];
      var lon = sensor['Lon'];
      var pm = sensor['pm2_5_atm']; // Draw a market with a calculated AQI
      ...
      bounds.extend(loc); // auto-zoom and center. ideally would be calling this once, and not
      // per-market
...
},{"process":"../../../../../../usr/local/lib/node_modules/parcel-bundler/node_modules/process/browser.js","isomorphic-fetch":"../node_modules/isomorphic-fetch/fetch-npm-browserify.js","fetch-retry":"../node_modules/fetch-retry/index.js"}],"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
